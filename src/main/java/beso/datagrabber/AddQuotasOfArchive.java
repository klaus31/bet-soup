...
import beso.services.QuotaServiceArchiveTipico;
import beso.tools.BesoAsciiArtTable;

@Component
public class AddQuotasOfArchive implements Launchable {
  ...
  public void launch() {
    ...
    final QuotaService quotaService = new QuotaServiceArchiveTipico(matches);
